    ...
    <script>
        ...
        $(function () {
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src", "${pageContext.request.contextPath}/getCode?time=" + new Date().getTime());
            });
        });
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.status){
                            ...
                            // 会一值添加 错误的元素 bug
                            $(".alert").remove();
                            $("#loginForm").after("<span style=\"color: red\"  class='alert alert-danger ' id=\"loginMessage\">"+data.message+"</span>");
                        }
                    }
                })
            })
